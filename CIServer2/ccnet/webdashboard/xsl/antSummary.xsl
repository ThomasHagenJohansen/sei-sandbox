...
-->
<!-- modified a bit by Kro to display debugging as well:
	- now shows warnings and errors first
	- and then everything incl. debug
-->
...
<!-- 	<table border="1" cellspacing="2" cellpadding="3" width="100%" style="font-size:80%">
  ...
  <table border="1" cellspacing="2" cellpadding="3" width="98%">
	  ...
	  <tr>
	    ...
	    <th nowrap="yes" align="left" width="1%">severity</th>
...
<xsl:template match="message">
  <tr valign="top">
    ...
    <td nowrap="yes" align="left" width="1%"> <xsl:value-of select="../../@name"/> </td>
    <td nowrap="yes" align="left" width="1%">[ <xsl:value-of select="../@name"/> ]</td>
    <td nowrap="yes" align="left" width="1%"> <xsl:value-of select="@priority"/> </td>
    <td class="{@priority}"> <xsl:value-of select="text()"/> </td>
  </tr>
</xsl:template>
